...
const GetStartedBtn = ({ text }) => {
    return (
        <div>
            <span className="px-4 lg:px-6 py-2 lg:py-3 relative rounded-xl group text-white font-medium inline-block mx-2">
                ...
                <span className="relative font-semibold text-xl whitespace-nowrap">{text}</span>
            </span>
        </div>
    )
}
