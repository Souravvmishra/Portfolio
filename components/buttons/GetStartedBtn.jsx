...
const GetStartedBtn = ({ text }) => {
    return (
        <div>
            <span className="px-4 lg:px-6 py-2 lg:py-3 relative rounded-xl group text-white font-medium inline-block">
                ...
                <span className="relative font-semibold text-xl">{text}</span>
            </span>
        </div>
    )
}
